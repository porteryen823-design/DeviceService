import {
  ...
  get,
  set
} from "./chunk-2KXFZ4IK.js";
import "./chunk-TG2AOK6M.js";
  ...
  return void 0 === n && (n = {}), void 0 === a && (a = {}), function(s2, i2, c) {
    try {
      return Promise.resolve((function(t, r2) {
        try {
          var u = (n.context && false, Promise.resolve(o3["sync" === a.mode ? "validateSync" : "validate"](s2, Object.assign({ abortEarly: false }, n, { context: i2 }))).then(function(t2) {
